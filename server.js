...
setInterval(() => {
  http.get(`https://marazgaming.glitch.me/`);
}, 280000);
...
const developers = ["451360686824488960", ""];
...
client.on("message", async message => {
  if (message.content.startsWith(prefix + "help")) {
    let help = new Discord.RichEmbed().setColor("0x5016f3")
      .setDescription(`** ❤❤ By Maraz Gaming❤❤
             ✅ برودكاست عادي : ${prefix}bc 🔴
         =============================
            📛 **SUPPORT_Bot_CLANGC** 📛
             📛 https://discord.io/Marazgaming📛
              **`);
      ...
      .then(m => {
        ...
        yes.on("collect", v => {
          ...
          message.guild.members
            .filter(r => r.presence.status !== "online")
            .forEach(member => {
